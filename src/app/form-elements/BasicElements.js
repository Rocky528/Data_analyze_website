              ...
              <div className="card-body">
                ...
                <Form.Group >
                  <div className="input-group" >
                    <Form.Control type="text" style={{ borderRadius: '6px 0px 0px 6px', backgroundColor: "#3B4758", borderColor: "#3B4758" }} className="form-control" aria-label="Username" aria-describedby="basic-addon1" />
                    <div className="input-group-prepend">
                      <span className="input-group-text " style={{ borderRadius: '0px 6px 6px 0px', color: '#BAC4D1', backgroundColor: "#3B4758", borderColor: "#3B4758" }}>$</span>
                    </div>
                  </div>
                </Form.Group>
                <Form.Group>
